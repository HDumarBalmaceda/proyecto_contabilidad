...
def obtener_contexto_proceso(proceso_id):
    ...
    try:
        ...
        if 'MILLON' in texto_letras:
            total_letras_final = f"{texto_letras} DE PESOS ML"
        else:
            ...
            for i, nombre_p in enumerate(archivos_docs, start=1):
                ...
                if colegio.firma_path:
                    ...
                    if os.path.exists(r_firma):
                        contexto['firma'] = InlineImage(doc, r_firma, width=Mm(45)) # Dimensión fija para firma
                ...
                doc.save(path_word)
                # ... (lógica de PDF y zf.write igual)
